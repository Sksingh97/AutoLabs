            ...
            case "Eye":
                return (<View>
                    <TouchableOpacity onPress={()=>{
                        ...
                        {
                        secureText?
                        <Show width={20} height={20} fill={colors.Text}/>
                        :
                        <Hide width={20} height={20} fill={colors.Text}/>
                        }
                    </TouchableOpacity>
                </View>)
            case "Add":
    ...
    return (
        <View style = {[styles.container, containerStyle]}>
            ...
            <View style={styles.fieldContainer}>
                ...
                <View>
                    <TextInput onBlur={onFocusOut} maxLength={maxLength} style={styles.inputField} placeholder={placeHolder} secureTextEntry ={secureText} keyboardType={keyboardType} onChangeText={onChange}/>
                </View>
